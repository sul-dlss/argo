...
To run just the linters, run `bin/rake lint`. To run the linters individually, run `bundle exec rake erblint`, `bundle exec rubocop`, and `bundle exec rake jslint`
