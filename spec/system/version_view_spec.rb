  ...
  context 'when viewing the object' do
    ...
    let(:solr_doc) do
      {
        ...
        SolrDocument::FIELD_APO_ID => 'druid:ww057qx5555',
    ...
    context 'when viewing the version' do
      it 'shows the current version' do
        ...
        expect(version_client).to have_received(:solr).with('2', validate: false)
      end
    end
    ...
    context 'when viewing an older version' do
      it 'shows the older system version banner' do
        ...
        expect(version_client).to have_received(:solr).with('1', validate: false)
      end
    end
