...
RSpec.describe FileHierarchyService do
  subject(:root_directory) { described_class.to_hierarchy(cocina_object: cocina_object) }

  let(:cocina_object) { instance_double(Cocina::Models::DRO, structural: structural) }
      ...
      FileHierarchyService::Directory.new("", [
        FileHierarchyService::Directory.new("dir1", [
          FileHierarchyService::Directory.new("dir2", [], [
            FileHierarchyService::File.new("bb045jk9908_0003.jp2", 5391263)
          ], 3)
        ], [
          FileHierarchyService::File.new("bb045jk9908_0002.tiff", 19962338),
          FileHierarchyService::File.new("bb045jk9908_0002.jp2", 4391262)
        ], 2)
      ], [
        FileHierarchyService::File.new("bb045jk9908_0001.tiff", 22454748),
        FileHierarchyService::File.new("bb045jk9908_0001.jp2", 4379498)
      ], 1)
    )
  end
end
