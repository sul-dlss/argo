...
RSpec.describe DescriptionsGrouper do
    ...
    JSON.parse(
      <<~JSON
      {
        "contributor": [{
          "name": [{
            "value": "Wong, Martin",
            "uri": "http://vocab.getty.edu/ulan/500043254",
            "source": {
              "code": "ulan",
        ...
        "subject": [{
          "value": "Fishermen",
          "type": "topic",
          "displayLabel": "Associated topics"
        }, {
          "value": "Peter Needham",
          "type": "topic",
          "displayLabel": "Associated topics"
        ...
        "access": {
          "digitalLocation": [{
            "value": "Private collection, Eureka",
            "type": "discovery"
          }],
          "accessContact": [{
            "value": "Digital image held by the Stanford Libraries.",
            "type": "repository"
          }]
        },
        "adminMetadata": {
        ...
        "purl": "https://purl.stanford.edu/bb467kj6050"
      }
      JSON
    )
  end
  let(:description2) do
    ...
    <<~JSON
    {
      ...
      "access": {
        "digitalLocation": [{
          "value": "The Martin Wong Foundation (P.P.O.W Gallery, New York)",
          "type": "discovery"
        }],
        "accessContact": [{
          "value": "Digital image held by the Stanford Libraries.",
      ...
      "purl": "https://purl.stanford.edu/bb560fk6027"
    }
    JSON
  )
  end
    ...
    JSON.parse(
      <<~JSON
      {
        "title": [{
          ...
          "value": "Untitled (brick trapezoid)",
          "type": "alternative"
        }],
        "contributor": [{
          "name": [{
        ...
        "purl": "https://purl.stanford.edu/bb976rq0538"
      }      
      JSON
    )
  end
  ...
  context "with a more complex example containing multiple repeat values" do
    ...
    let(:description1) do
      JSON.parse(
        <<~JSON
        {
          "title": [{
            "structuredValue": [{
              "value": "FFIEC HMDA raw data 2003",
              "type": "main title"
            }, {
              "value": "part 17",
              "type": "part number"
          ...
          "purl": "https://sul-purl-stage.stanford.edu/kg986pw1063"
        }
        JSON
      )
    ...
    let(:description2) do
      JSON.parse(
        <<~JSON
        {
          "title": [{
            "structuredValue": [{
              "value": "NIST surface structure database",
              "type": "main title"
            }, {
              "value": "(SSD)",
              "type": "subtitle"
          ...
          "access": {
            "url": [{
              "value": "http://www.fhi-berlin.mpg.de/KHsoftware/oSSD/"
            }]
          },
          "relatedResource": [{
            "type": "in series",
            "title": [{
              "structuredValue": [{
                "value": "NIST standard reference database",
                "type": "main title"
              }, {
                "value": "42",
                "type": "part number"
          ...
          "purl": "https://sul-purl-stage.stanford.edu/qg486xd2400"
        }
        JSON
      )
    end
    let(:description3) do
      JSON.parse(
        <<~JSON
        {
          "title": [{
            "structuredValue": [{
              "value": "GeocodeDVD 2012 estimates/2017 projections",
              "type": "main title"
            }, {
              "value": "Tiger2011",
              "type": "subtitle"
          ...
          "subject": [{
            "value": "Geographical location codes",
            "type": "topic",
            "source": {
              "code": "lcsh"
            }
          ...
          "purl": "https://sul-purl-stage.stanford.edu/sm561bg8999"
        }        
        JSON
      )
    end
        ...
        <<~JSON
        {
          "title": [{
            "structuredValue": [{
              ...
              "value": "2016 estimates/2021 projections",
              "type": "subtitle"
            }],
            "status": "primary"
          }],
          ...
          "purl": "https://sul-purl-stage.stanford.edu/tr125sy5253"
        }        
        JSON
      )
    end
        ...
        <<~JSON
        {
          "title": [{
            "structuredValue": [{
              ...
              "value": "New York Times TDM archive",
              "type": "main title"
            }],
            "status": "primary"
          }],
          ...
          "purl": "https://sul-purl-stage.stanford.edu/tw155vv5117"
        }        
        JSON
      )
    end
    let(:description6) do
      JSON.parse(
        ...
        {
          "title": [{
            "value": "Associated Press collections",
            "status": "primary"
          }],
          "form": [{
            "value": "numeric data",
          ...
          "purl": "https://sul-purl-stage.stanford.edu/vc609bv8108"
        }        
        JSON
      )
    end
