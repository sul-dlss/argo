...
RSpec.describe DescriptionsGrouper do
  ...
  context "with a more complex example containing multiple repeat values" do
    ...
    it "groups notes as expected" do
      ...
      expect(run.dig(druid2, "note3.value")).to eq("User's guide entitled: NIST surface structure database (SSD) with interactive analysis and visualization / authors, P.R. Watson, M.A. Van Hove, K. Herrmann.")
