...
describe DorController do
  ...
  describe 'dor indexing' do
    ...
    it 'all of the gdor fields should be present in the hash' do
      [:sw_title_245a_search_facet_facet,
        :sw_title_245_search_facet_facet,
        :sw_title_variant_search_facet_facet,
        :sw_title_sort_facet,
        :sw_title_245a_display_facet,
        :sw_title_display_facet,
        :sw_title_full_display_facet,
        :sw_author_1xx_search_facet_facet,
        :sw_author_7xx_search_facet_facet,
        :sw_author_person_facet_facet,
        :sw_author_other_facet_facet,
        :sw_author_corp_display_facet,
        :sw_author_meeting_display_facet,
        :sw_author_person_display_facet,
        :sw_author_person_full_display_facet,
        :sw_topic_search_facet_facet,
        :sw_geographic_search_facet_facet,
        :sw_subject_other_search_facet_facet,
        :sw_subject_other_subvy_search_facet_facet,
        :sw_subject_all_search_facet_facet,
        :sw_topic_facet_facet,
        :sw_geographic_facet_facet,
        :sw_era_facet_facet,
        :sw_language_facet,
        :sw_pub_search_facet_facet,
        :sw_pub_date_sort_facet,
        :sw_pub_date_group_facet_facet,
        :sw_pub_date_facet,
        :sw_pub_date_display_facet,
        :sw_all_search_facet_facet,
        :sw_format_facet].each do |key|
          expect(@solr_doc.has_key?(key)).to be true
        end
    end
