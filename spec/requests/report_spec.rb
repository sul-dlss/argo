  ...
  describe "The JSON endpoint" do
    ...
    context "with user custom entered dates" do
      ...
      it "returns data for custom date searches" do
        params = {f: {modified_latest_dttsi: ["[2015-10-01T00:00:00.000Z TO 2050-10-07T23:59:59.000Z]"]}, per_page: 5}
        ...
        expect(Report).to have_received(:new)
          .with(
            hash_including(f: {"modified_latest_dttsi" => ["[2015-10-01T00:00:00.000Z TO 2050-10-07T23:59:59.000Z]"]}, per_page: 5),
            anything
          )
