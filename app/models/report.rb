  ...
  configure_blacklight do |config|
    ...
    config.report_fields = [
      ...
      },
      {
        ...
        :solr_fields => %w(public_dc_creator_tesim dc_creator_tesim public_dc_title_tesim dc_title_si obj_label_teim originInfo_place_placeTerm_tesim public_dc_publisher_tesim originInfo_publisher_tesim public_dc_date_tesim),
