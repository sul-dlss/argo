  ...
  configure_blacklight do |config|
    ...
    config.report_fields = [
      ...
      },
      {
        ...
        :solr_fields => %w(sw_display_title_tesim public_dc_title_tesim dc_title_tesim obj_label_ssim),
        :sort => false, :default => false, :width => 100
      },
      {
        :field => :citation, :label => 'Citation',
        :proc => lambda { |doc| render_citation(doc) },
        :solr_fields => %w(sw_author_tesim public_dc_creator_tesim dc_creator_tesim sw_display_title_tesim public_dc_title_tesim dc_title_tesim obj_label_ssim originInfo_place_placeTerm_tesim public_dc_publisher_tesim originInfo_publisher_tesim public_dc_date_tesim),
