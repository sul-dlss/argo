...
class UploadsController < ApplicationController
  ...
  def create
    ...
    temp_spreadsheet_filename = "#{params.expect(:spreadsheet_file).original_filename}.#{directory_name}"
    ...
    FileUtils.copy(params.expect(:spreadsheet_file).path, temp_filename)
