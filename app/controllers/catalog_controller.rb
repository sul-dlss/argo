...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'nonhydrus_collection_title_ssim', :label => 'Non-Hydrus Collection',  :sort => 'index'
    config.add_facet_field 'hydrus_collection_title_ssim',    :label => 'Hydrus Collection',  :sort => 'index'
    config.add_facet_field 'nonhydrus_apo_title_ssim',        :label => 'Non-Hydrus Admin Policy',:sort => 'index'
