  ...
  module ClassMethods
    def add_common_date_facet_fields_to_config!(config)
      ...
      config.add_facet_field 'registered_date', home: false, label: 'Registered',
                                                ...
                                                query: {
                                                  ...
                                                  days_7: { label: 'within 7 days',
                                                            fq: "#{SolrDocument::FIELD_REGISTERED_DATE}:[NOW/DAY-7DAYS TO *]" },
                                                  days_30: { label: 'within 30 days',
                                                             fq: "#{SolrDocument::FIELD_REGISTERED_DATE}:[NOW/DAY-30DAYS TO *]" }
      ...
      config.add_facet_field 'accessioned_latest_date', home: false, label: 'Last Accessioned',
                                                        ...
                                                        query: {
                                                          all: { label: 'All',
                                                                 fq: "#{SolrDocument::FIELD_LAST_ACCESSIONED_DATE}:*" },
                                                          days_7: { label: 'within 7 days',
                                                                    fq: "#{SolrDocument::FIELD_LAST_ACCESSIONED_DATE}:[NOW/DAY-7DAYS TO *]" },
                                                          days_30: { label: 'within 30 days',
                                                                     fq: "#{SolrDocument::FIELD_LAST_ACCESSIONED_DATE}:[NOW/DAY-30DAYS TO *]" }
                                                        }, raw_facet_field: SolrDocument::FIELD_LAST_ACCESSIONED_DATE
      config.add_facet_field SolrDocument::FIELD_LAST_ACCESSIONED_DATE, label: 'Last Accessioned', if: false,
                                                                        home: false
      ...
      config.add_facet_field 'accessioned_earliest_date', home: false, label: 'Earliest Accessioned',
                                                          ...
                                                          query: {
                                                            all: { label: 'All',
                                                                   fq: "#{SolrDocument::FIELD_EARLIEST_ACCESSIONED_DATE}:*" },
                                                            days_1: { label: 'within the last day',
                                                                      fq: "#{SolrDocument::FIELD_EARLIEST_ACCESSIONED_DATE}:[NOW/DAY-1DAYS TO *]" },
                                                            days_7: { label: 'within 7 days',
                                                                      fq: "#{SolrDocument::FIELD_EARLIEST_ACCESSIONED_DATE}:[NOW/DAY-7DAYS TO *]" },
                                                            days_30: { label: 'within 30 days',
                                                                       fq: "#{SolrDocument::FIELD_EARLIEST_ACCESSIONED_DATE}:[NOW/DAY-30DAYS TO *]" },
      ...
      config.add_facet_field SolrDocument::FIELD_EARLIEST_ACCESSIONED_DATE, label: 'Earliest Accessioned', if: false,
                                                                            home: false
