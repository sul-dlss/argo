class ItemsController < ApplicationController
  ...
  before_filter :enforce_versioning, :only => [:add_collection, :remove_collection, :update_rights,:tags,:source_id,:set_source_id, :tags_bulk, :set_content_type,:set_rights]
