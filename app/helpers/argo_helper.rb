...
module ArgoHelper
  ...
  def render_buttons(doc, object = nil)
    ...
    if pid
      ...
      # (DLWEBER: assuming this is how it should be.)
      buttons << {
    ...
    # TODO: many of these button display permissions
    # could use more granular requests.
    ...
    #current_user.can_manage?(@object, 'apo')
