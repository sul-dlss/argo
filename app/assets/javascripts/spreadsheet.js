...
var argoSpreadsheet = {
    ...
    enable_control : function(ctrl)
    {
	ctrl.prop("disabled", false);
    },

    load_upload_form : function()
    {
	...
	input_controls.map(argoSpreadsheet.disable_control);
	
	// Enable everything except for the submit button upon file upload
	$("#spreadsheet_file").change(function (){
	    input_controls.map(argoSpreadsheet.enable_control);
	});
...
Blacklight.onLoad(function(){
	...
	argoSpreadsheet.load_upload_form();
    });
});
